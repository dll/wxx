...
class _HomePageState extends State<HomePage> {
  ...
  Widget _buildStudentHomeContent(ThemeData theme) {
    ...
    return Column(
      ...
      children: [
        HomeGradeGrowthCard(
            grade: context.watch<ThemeNotifier>().grade,
            accent: context.watch<ThemeNotifier>().gradeAccent,
            themeName: context.watch<ThemeNotifier>().gradeThemeName),
        const SizedBox(height: 16),
        ...
        const SizedBox(height: 16),
        HomeTodayCourses(
            courses: ((_studentHomeData?['today_courses'] as List?)
