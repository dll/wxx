                  ...
                  Container(
                    ...
                    child: Row(children: [
                      ...
                      Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        ...
                        Text('AI 匹配学习伙伴', style: TextStyle(color: theme.colorScheme.onPrimary.withOpacity( 0.8), fontSize: 13)),
                      ])),
                    ]),
                  ),
                    ...
                    Card(
                      child: Padding(
                        ...
                        child: Column(children: [
                          Icon(Icons.people, size: 48, color: theme.colorScheme.primary.withOpacity( 0.5)),
