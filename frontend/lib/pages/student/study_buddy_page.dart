...
class _StudyBuddyPageState extends State<StudyBuddyPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text('AI 学伴')),
        ...
        children: [
          ...
          Expanded(
            child: Column(
              ...
              children: [
                Text('AI 学伴', style: TextStyle(color: theme.colorScheme.onPrimary, fontSize: 18, fontWeight: FontWeight.bold)),
                const SizedBox(height: 4),
                Text('AI 学习伙伴：出题互测与讨论', style: TextStyle(color: theme.colorScheme.onPrimary.withValues(alpha: 0.8), fontSize: 13)),
              ],
            ),
          ),
        ],
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            ...
            Text('AI 学习伙伴：出题互测与讨论', style: theme.textTheme.bodyMedium?.copyWith(color: theme.colorScheme.onSurfaceVariant), textAlign: TextAlign.center),
          ],
        ),
      ),
    );
