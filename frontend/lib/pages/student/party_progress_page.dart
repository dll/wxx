...
class _PartyProgressPageState extends State<PartyProgressPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text('入党入团进度')),
        ...
        children: [
          ...
          Expanded(
            child: Column(
              ...
              children: [
                Text('入党入团进度', style: TextStyle(color: theme.colorScheme.onPrimary, fontSize: 18, fontWeight: FontWeight.bold)),
                const SizedBox(height: 4),
                Text('入党入团各环节进度追踪', style: TextStyle(color: theme.colorScheme.onPrimary.withValues(alpha: 0.8), fontSize: 13)),
              ],
            ),
          ),
        ],
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            ...
            Text('入党入团各环节进度追踪', style: theme.textTheme.bodyMedium?.copyWith(color: theme.colorScheme.onSurfaceVariant), textAlign: TextAlign.center),
          ],
        ),
      ),
    );
