                  ...
                  Container(
                    ...
                    child: Row(children: [
                      ...
                      Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        ...
                        Text('入党流程进度跟踪', style: TextStyle(color: theme.colorScheme.onPrimary.withValues(alpha: 0.8), fontSize: 13)),
                      ])),
                    ]),
                  ),
                    ...
                    Card(
                      child: Padding(
                        ...
                        child: Column(children: [
                          Icon(Icons.flag, size: 48, color: theme.colorScheme.primary.withValues(alpha: 0.5)),
