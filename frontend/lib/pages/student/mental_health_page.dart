...
class _MentalHealthPageState extends State<MentalHealthPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text('AI 心理陪伴')),
        ...
        children: [
          ...
          Expanded(
            child: Column(
              ...
              children: [
                Text('AI 心理陪伴', style: TextStyle(color: theme.colorScheme.onPrimary, fontSize: 18, fontWeight: FontWeight.bold)),
                const SizedBox(height: 4),
                Text('每日心情打卡与正念引导', style: TextStyle(color: theme.colorScheme.onPrimary.withValues(alpha: 0.8), fontSize: 13)),
              ],
            ),
          ),
        ],
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            ...
            Text('每日心情打卡与正念引导', style: theme.textTheme.bodyMedium?.copyWith(color: theme.colorScheme.onSurfaceVariant), textAlign: TextAlign.center),
          ],
        ),
      ),
    );
