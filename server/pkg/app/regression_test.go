...
func TestRouteRegistrationCount(t *testing.T) {
	...
	for _, route := range []string{"/vopc", "/projects", "/projects/:id", "/projects/:id/tasks", "/projects/:id/tasks/:taskId", "/projects/:id/submit", "/projects/:id/members", "/invitations", "/invitations/:invitationId/respond", "/projects/:id/artifacts", "/projects/:id/artifacts/:artifactId/versions", "/projects/:id/milestone-submissions", "/projects/:id/milestone-submissions/:submissionId/review", "/projects/:id/files", "/projects/:id/files/:key", "/projects/:id/close", "/projects/:id/close-records", "/projects/:id/risks", "/projects/:id/risks/:riskId/approve", "/projects/:id/freeze", "/projects/:id/risk-appeals", "/projects/:id/risk-appeals/:appealId/resolve", "/projects/:id/governance-roles", "/projects/:id/ai-tasks", "/projects/:id/ai-tasks/:taskId", "/projects/:id/ai-tasks/:taskId/review", "/projects/:id/ai-tasks/:taskId/retry"} {
